    ...
    <b-container fluid>
      ...
      >
        ...
        <template #cell(actions)="row">
          <b-link :to="{ name: 'ProductsId', params: { id: row.item.id } }">
            <b-icon-search></b-icon-search>
          </b-link>
          <b-link :to="{ name: 'ProductsEditId', params: { id: row.item.id } }">
      ...
      fields: [
        {
           ...
           * users id (후보키) */
          key: "usersId",
          label: this.$t("products_users_id")
        },
        {
          /**
           * 상품명 */
          key: "name",
          label: this.$t("products_name")
        },
        {
          /**
           * 상태 */
          key: "status",
          label: this.$t("products_status")
        },
        {
          /**
           * Action
