    ...
    <b-container fluid>
      ...
      <b-table striped hover :items="items" :fields="fields">
        <template #cell(actions)="row">
          <b-link :to="{ name: 'CartsId', params: { id: row.item.id } }">
            <b-icon-search></b-icon-search>
          </b-link>
          <b-link :to="{ name: 'CartsEditId', params: { id: row.item.id } }">
      ...
      fields: [
        {
           ...
           * users id (후보키) */
          key: "usersId",
          label: this.$t("carts_users_id")
        },
        {
          /**
           * products id (후보키) */
          key: "productsId",
          label: this.$t("carts_products_id")
        },
        {
          /**
           * productsOptions id (후보키) */
          key: "productsOptionsId",
          label: this.$t("carts_products_options_id")
        },
        {
          /**
           * 상태 */
          key: "status",
          label: this.$t("carts_status")
        },
        {
          /**
           * Action
